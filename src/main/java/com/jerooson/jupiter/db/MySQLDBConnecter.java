package com.jerooson.jupiter.db;
...
public class MySQLDBConnecter {
    private static final String INSTANCE = "ganeplus-database.cskcqgsjkcev.us-east-2.rds.amazonaws.com";
    ...
    public static String getMySQLAddress() throws IOException {
        ...
        InputStream inputStream = MySQLDBConnecter.class.getClassLoader().getResourceAsStream(propFileName);
